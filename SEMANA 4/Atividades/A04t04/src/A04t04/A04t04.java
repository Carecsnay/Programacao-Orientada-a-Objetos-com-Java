...
public class A04t04 {
    ...
    public static void main(String[] args) {
        ...
        if (comidaPreferida.equalsIgnoreCase("Arroz")
                ...
                || comidaPreferida.equalsIgnoreCase("Cuzcuz")
            ...
            System.out.println("Máquina: Sério? Eu amo " + comidaPreferida + "!");
        } else {
        ...
        if (corPreferida.equalsIgnoreCase("Preta")) {
            ...
            System.out.println("Máquina: Preto é minha cor favorita, você tem bom gosto!");
        } else {
            System.out.println("Máquina: Não curto muito essa cor!");
        }
        ...
        if (animalPreferido.equalsIgnoreCase("sim")
            ...
            System.out.println("Máquina: Experimente a felicidade, você não vai se arrepender! #adote");
        }
